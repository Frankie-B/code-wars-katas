...
(function() {
    ...
    const D = i.unshift;
    const E = n.toString;
    const l = n.hasOwnProperty;
    const s = i.forEach;
    const t = i.map;
    const u = i.reduce;
    const v = i.reduceRight;
    const w = i.filter;
    const x = i.every;
    const y = i.some;
    const o = i.indexOf;
    const z = i.lastIndexOf;
    n = Array.isArray;
    const F = Object.keys;
    ...
    b.VERSION = '1.1.6';
    const h = (b.each = b.forEach = function(a, c, d) {
        if (a != null)
    ...
    b.uniq = b.unique = function(a, c) {
        return b.reduce(
            a,
            function(a, e, f) {
                if (f == 0 || (c === !0 ? b.last(a) != e : !b.include(a, e))) a[a.length] = e;
                return a;
            },
            []
        );
    ...
    b.lastIndexOf = function(a, b) {
        ...
        for (let d = a.length; d--; ) if (a[d] === b) return d;
        return -1;
    };
    ...
    b.memoize = function(a, c) {
        ...
        c || (c = b.identity);
        return function() {
            const b = c.apply(this, arguments);
    ...
    b.wrap = function(a, b) {
        return function() {
            const d = [a].concat(f.call(arguments));
    ...
    b.extend = function(a) {
        h(f.call(arguments, 1), function(b) {
            for (const d in b) b[d] !== void 0 && (a[d] = b[d]);
        });
        return a;
    };
    ...
    b.isEqual = function(a, c) {
        ...
        for (const f in a) if (!(f in c) || !b.isEqual(a[f], c[f])) return !1;
        return !0;
    };
    b.isEmpty = function(a) {
        if (b.isArray(a) || b.isString(a)) return a.length === 0;
        for (const c in a) if (l.call(a, c)) return !1;
        return !0;
    };
    ...
    b.template = function(a, c) {
        let d = b.templateSettings;
        d = `var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('${a
            .replace(/\\/g, '\\\\')
            .replace(/'/g, "\\'")
