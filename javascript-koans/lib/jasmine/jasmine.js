...
jasmine.Matchers.prototype.toHaveBeenCalledWith = function() {
    ...
    this.message = function() {
        ...
        return [
            `Expected spy to have been called with ${jasmine.pp(expectedArgs)} but was called with ${jasmine.pp(
                this.actual.argsForCall
            )}`,
            `Expected spy not to have been called with ${jasmine.pp(expectedArgs)} but was called with ${jasmine.pp(
                this.actual.argsForCall
            )}`,
        ];
    };
